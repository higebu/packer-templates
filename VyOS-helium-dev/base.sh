...
sudo aptitude -o Aptitude::Cmdline::ignore-trust-violations=true -y install build-essential
sudo aptitude -o Aptitude::Cmdline::ignore-trust-violations=true -y install linux-vyatta-kbuild
